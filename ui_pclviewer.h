...
public:
    ...
    void setupUi(QMainWindow *PCLViewer)
    {
        ...
        KinectAction = new QAction(PCLViewer);
        KinectAction->setObjectName(QString::fromUtf8("KinectAction"));
    ...
    void retranslateUi(QMainWindow *PCLViewer)
    {
        ...
        KinectAction->setText(QApplication::translate("PCLViewer", "Kinect", 0, QApplication::UnicodeUTF8));
